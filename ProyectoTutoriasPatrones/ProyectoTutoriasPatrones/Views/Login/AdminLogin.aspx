<%@ Page Title="" Language="C#" MasterPageFile="~/MasterStyles/LoginMain.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="ProyectoTutoriasPatrones.MasterStyles.Formulario_web1" %>
        ...
        <table style="width: 100%; height: 185px;">
            ...
            <tr>
                ...
                <td class="auto-style6" style="width: 60px; text-align: right;">
                    <asp:Button ID="btnIngresar" runat="server" Text="Ingresar" Width="100px" OnClick="btnIngresar_Click" />
                </td>
            </tr>
        </table>
    </form>
