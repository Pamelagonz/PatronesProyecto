<%@ Page Title="" Language="C#" MasterPageFile="~/MasterStyles/LoginMain.Master" AutoEventWireup="true" CodeBehind="AsistenteLogin.aspx.cs" Inherits="ProyectoTutoriasPatrones.MasterStyles.Formulario_web12" %>
        ...
        <table style="width: 100%; height: 185px;">
            ...
            <tr>
                ...
                <td style="text-align: right;">
                    <asp:Button ID="ButtonRegistrarte" runat="server" Text="Registrarte" Width="100px" />
                </td>
